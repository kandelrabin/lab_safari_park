...
CREATE TABLE assignments(
    id SERIAL PRIMARY KEY,
    day VARCHAR(255),
    employee_id INTEGER REFERENCES staffs(id),
    enclosure_id INTEGER REFERENCES enclosures(id)
);

INSERT INTO staffs (name, employee_number) VALUES ('Sunny', 0121);
INSERT INTO staffs (name, employee_number) VALUES ('Zuhair', 0161);
INSERT INTO staffs (name, employee_number) VALUES ('Rabin', 0200);
